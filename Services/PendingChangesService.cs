...
namespace IDNACCalculator.Services
{
    ...
    public class PendingChangesService
    {
        ...
        public List<IDNACCalculator.Models.ValidationResult> ValidateAllChanges()
        {
            var results = new List<IDNACCalculator.Models.ValidationResult>();
            ...
            foreach (var group in addressGroups)
            {
                ...
                var validationResult = new IDNACCalculator.Models.ValidationResult();
        ...
        private IDNACCalculator.Models.ValidationResult ValidateChange(PendingChange change)
        {
