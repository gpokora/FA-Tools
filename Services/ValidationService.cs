...
namespace IDNACCalculator.Services
{
    /// <summary>
    ...
    public class ValidationService
    {
        ...
        public IDNACCalculator.Models.ValidationResult ValidateCircuitBranch(CircuitBranch branch, double sparePercent = 20.0)
        {
            var result = new IDNACCalculator.Models.ValidationResult();
        ...
        public IDNACCalculator.Models.ValidationResult ValidatePowerSupply(PowerSupply powerSupply)
        {
            var result = new IDNACCalculator.Models.ValidationResult();
        ...
        private void ValidateCableRun(CircuitBranch branch, IDNACCalculator.Models.ValidationResult result)
        {
    ...
    public class ValidationSummary
    {
        ...
        public Dictionary<string, IDNACCalculator.Models.ValidationResult> BranchValidations { get; set; } = new Dictionary<string, IDNACCalculator.Models.ValidationResult>();
        public Dictionary<string, IDNACCalculator.Models.ValidationResult> PowerSupplyValidations { get; set; } = new Dictionary<string, IDNACCalculator.Models.ValidationResult>();
