...
namespace IDNACCalculator.Services
{
    public class CircuitOrganizationService
    {
        ...
        private IDNACCalculator.Models.ValidationResult ValidateCircuitOrganization(CircuitOrganizationResult result)
        {
            var validation = new IDNACCalculator.Models.ValidationResult();
        ...
        private void ValidateBranch(CircuitBranch branch, IDNACCalculator.Models.ValidationResult validation)
        {
        ...
        private void ValidatePowerSupply(PowerSupply ps, IDNACCalculator.Models.ValidationResult validation)
        {
    ...
    public class CircuitOrganizationResult
    {
        ...
        public IDNACCalculator.Models.ValidationResult ValidationResult { get; set; } = new IDNACCalculator.Models.ValidationResult();
    }
